...
B20, B22, B2m2 = sympy.symbols('B20, B22, B2m2')
B40, B42, B4m2, B43, B4m3, B44, B4m4 = sympy.symbols('B40, B42, B4m2, B43, B4m3, B44, B4m4')
B60, B62, B6m2, B63, B6m3, B64, B6m4, B66, B6m6 = sympy.symbols('B60, B62, B6m2, B63, B6m3, B64, B6m4, B66, B6m6')
...
#		H = sympy.Matrix(B20 * O_20(Jval) + B22 * O_22(Jval) + B40 * O_40(Jval) + B42 * O_42(Jval) + B43 * O_43(Jval) + B44 * O_44(Jval) + B60 * O_60(Jval) + B62 * O_62(Jval) + B63 * O_63(Jval) + B64 * O_64(Jval) + B66 * O_66(Jval))
	case 'monoclinic':
		H = sympy.Matrix(B20 * O_20(Jval) + B22 * O_22(Jval) + B2m2 * O_2m2(Jval) + \
				 B40 * O_40(Jval) + B42 * O_42(Jval) +  B4m2 * O_4m2(Jval) + B44 * O_44(Jval) + B4m4 * O_4m4(Jval) + \
				 B60 * O_60(Jval) + B62 * O_62(Jval) + B6m2 * O_6m2(Jval) + B64 * O_64(Jval) + B6m4 * O_6m4(Jval) + B66 * O_66(Jval) + B6m6 * O_6m6(Jval))
	case 'rhombic':
		H = sympy.Matrix(B20 * O_20(Jval) + B22 * O_22(Jval) + \
				 B40 * O_40(Jval) + B42 * O_42(Jval) + B44 * O_44(Jval) + \
				 B60 * O_60(Jval) + B62 * O_62(Jval) + B64 * O_64(Jval) + B66 * O_66(Jval))
	case 'tetragonal_1':
		H = sympy.Matrix(B20 * O_20(Jval) + \
